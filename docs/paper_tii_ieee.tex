...
\author{Shang~Yang,~\IEEEmembership{Student Member,~IEEE}~and~Bin~Zhang,~\IEEEmembership{Senior Member,~IEEE}%
\thanks{S.~Yang is an undergraduate student (Class of 2024) with Shandong University, Weihai, China (e-mail: yangshangky@163.com).}%
\thanks{B.~Zhang is with Shandong University, China. He is the corresponding author (e-mail: to-be-filled@email).}%
